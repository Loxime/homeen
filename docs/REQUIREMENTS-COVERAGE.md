...
| Create / modify / delete tag | Tags API + sidebar tag manager |
...
| Sidebar notes/tags/pomodoro/statistics | Main application shell |
...
| Most resolved tag | Completion-event tag snapshot aggregation with legacy label compatibility |
